    ...
    async def _aget_by_field_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/members/{idMember}/{field}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetByFieldRaw(BaseApi):
    ...
    async def aget_by_field(
        ...
        **kwargs,
        ...
        args = self._get_by_field_mapped_args(
            id_member=id_member,
            field=field,
        )
        return await self._aget_by_field_oapg(
    ...
    def get_by_field(
        ...
        return self._get_by_field_oapg(
            path_params=args.path,
        )

class GetByField(BaseApi):
    ...
    async def aget_by_field(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_by_field(
            id_member=id_member,
            field=field,
            **kwargs,
        )
    ...
    def get_by_field(
        ...
        raw_response = self.raw.get_by_field(
            id_member=id_member,
            field=field,
        )
