...
class BaseApi(api_client.Api):
    ...
    def _get_lists_by_id_board_mapped_args(
        self,
        id_board: str,
    ...
    async def _aget_lists_by_id_board_oapg(
        self,
    ...
    def _get_lists_by_id_board_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetListsByIdBoardRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_lists_by_id_board(
        self,
        id_board: str,
        cards: typing.Optional[str] = None,
        card_fields: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._get_lists_by_id_board_mapped_args(
            id_board=id_board,
            cards=cards,
        ...
        return await self._aget_lists_by_id_board_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def get_lists_by_id_board(
        self,
        id_board: str,
        cards: typing.Optional[str] = None,
        card_fields: typing.Optional[str] = None,
        ...
        return self._get_lists_by_id_board_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetListsByIdBoard(BaseApi):
    ...
    async def aget_lists_by_id_board(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_lists_by_id_board(
            id_board=id_board,
            cards=cards,
            card_fields=card_fields,
            filter=filter,
    ...
    def get_lists_by_id_board(
        ...
        raw_response = self.raw.get_lists_by_id_board(
            id_board=id_board,
            cards=cards,
            card_fields=card_fields,
            filter=filter,
