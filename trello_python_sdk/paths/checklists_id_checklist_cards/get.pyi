...
class BaseApi(api_client.Api):
    ...
    def _list_cards_by_id_checklist_mapped_args(
        self,
        id_checklist: str,
    ...
    async def _alist_cards_by_id_checklist_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/checklists/{idChecklist}/cards',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _list_cards_by_id_checklist_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class ListCardsByIdChecklistRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_cards_by_id_checklist(
        self,
        id_checklist: str,
        actions: typing.Optional[str] = None,
        attachments: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._list_cards_by_id_checklist_mapped_args(
        ...
        return await self._alist_cards_by_id_checklist_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def list_cards_by_id_checklist(
        self,
        id_checklist: str,
        actions: typing.Optional[str] = None,
        attachments: typing.Optional[str] = None,
        ...
        return self._list_cards_by_id_checklist_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class ListCardsByIdChecklist(BaseApi):
    ...
    async def alist_cards_by_id_checklist(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.alist_cards_by_id_checklist(
            id_checklist=id_checklist,
            actions=actions,
            attachments=attachments,
            attachment_fields=attachment_fields,
    ...
    def list_cards_by_id_checklist(
        ...
        raw_response = self.raw.list_cards_by_id_checklist(
            id_checklist=id_checklist,
            actions=actions,
            attachments=attachments,
            attachment_fields=attachment_fields,
