...
class BaseApi(api_client.Api):
    ...
    def _get_attachments_by_id_card_mapped_args(
        self,
        id_card: str,
    ...
    async def _aget_attachments_by_id_card_oapg(
        self,
    ...
    def _get_attachments_by_id_card_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetAttachmentsByIdCardRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_attachments_by_id_card(
        self,
        id_card: str,
        fields: typing.Optional[str] = None,
        filter: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._get_attachments_by_id_card_mapped_args(
            id_card=id_card,
            fields=fields,
            filter=filter,
        )
        return await self._aget_attachments_by_id_card_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def get_attachments_by_id_card(
        self,
        id_card: str,
        fields: typing.Optional[str] = None,
        filter: typing.Optional[str] = None,
        ...
        return self._get_attachments_by_id_card_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetAttachmentsByIdCard(BaseApi):
    ...
    async def aget_attachments_by_id_card(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_attachments_by_id_card(
            id_card=id_card,
            fields=fields,
            filter=filter,
            **kwargs,
    ...
    def get_attachments_by_id_card(
        ...
        raw_response = self.raw.get_attachments_by_id_card(
            id_card=id_card,
            fields=fields,
            filter=filter,
        )
