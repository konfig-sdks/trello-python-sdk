...
class BaseApi(api_client.Api):
    ...
    def _list_actions_by_id_board_mapped_args(
        self,
        id_board: str,
    ...
    async def _alist_actions_by_id_board_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/boards/{idBoard}/actions',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _list_actions_by_id_board_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class ListActionsByIdBoardRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_actions_by_id_board(
        self,
        id_board: str,
        entities: typing.Optional[str] = None,
        display: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._list_actions_by_id_board_mapped_args(
            id_board=id_board,
            entities=entities,
            display=display,
            filter=filter,
        ...
        return await self._alist_actions_by_id_board_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def list_actions_by_id_board(
        self,
        id_board: str,
        entities: typing.Optional[str] = None,
        display: typing.Optional[str] = None,
        ...
        return self._list_actions_by_id_board_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class ListActionsByIdBoard(BaseApi):
    ...
    async def alist_actions_by_id_board(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.alist_actions_by_id_board(
            id_board=id_board,
            entities=entities,
            display=display,
            filter=filter,
    ...
    def list_actions_by_id_board(
        ...
        raw_response = self.raw.list_actions_by_id_board(
            id_board=id_board,
            entities=entities,
            display=display,
            filter=filter,
