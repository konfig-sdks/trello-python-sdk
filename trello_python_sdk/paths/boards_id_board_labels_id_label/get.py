...
class BaseApi(api_client.Api):
    ...
    def _get_labels_by_id_board_by_id_label_mapped_args(
        self,
        id_board: str,
        id_label: str,
    ...
    async def _aget_labels_by_id_board_by_id_label_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/boards/{idBoard}/labels/{idLabel}',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_labels_by_id_board_by_id_label_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetLabelsByIdBoardByIdLabelRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_labels_by_id_board_by_id_label(
        self,
        id_board: str,
        id_label: str,
        fields: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._get_labels_by_id_board_by_id_label_mapped_args(
            id_board=id_board,
            id_label=id_label,
            fields=fields,
        )
        return await self._aget_labels_by_id_board_by_id_label_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def get_labels_by_id_board_by_id_label(
        self,
        id_board: str,
        id_label: str,
        fields: typing.Optional[str] = None,
        ...
        return self._get_labels_by_id_board_by_id_label_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetLabelsByIdBoardByIdLabel(BaseApi):
    ...
    async def aget_labels_by_id_board_by_id_label(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_labels_by_id_board_by_id_label(
            id_board=id_board,
            id_label=id_label,
            fields=fields,
            **kwargs,
    ...
    def get_labels_by_id_board_by_id_label(
        ...
        raw_response = self.raw.get_labels_by_id_board_by_id_label(
            id_board=id_board,
            id_label=id_label,
            fields=fields,
        )
