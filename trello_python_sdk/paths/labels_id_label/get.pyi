...
class BaseApi(api_client.Api):
    ...
    def _get_by_id_label_mapped_args(
        self,
        id_label: str,
    ...
    async def _aget_by_id_label_oapg(
        self,
...
class GetByIdLabelRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_by_id_label(
        self,
        id_label: str,
        fields: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._get_by_id_label_mapped_args(
            id_label=id_label,
            fields=fields,
        )
        return await self._aget_by_id_label_oapg(
    ...
    def get_by_id_label(
        ...
        return self._get_by_id_label_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetByIdLabel(BaseApi):
    ...
    async def aget_by_id_label(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_by_id_label(
            id_label=id_label,
            fields=fields,
            **kwargs,
        )
    ...
    def get_by_id_label(
        ...
        raw_response = self.raw.get_by_id_label(
            id_label=id_label,
            fields=fields,
        )
