...
class BaseApi(api_client.Api):
    ...
    def _get_list_by_id_mapped_args(
        self,
        id_card: str,
    ...
    async def _aget_list_by_id_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/cards/{idCard}/list',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetListByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_list_by_id(
        self,
        id_card: str,
        fields: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._get_list_by_id_mapped_args(
            id_card=id_card,
            fields=fields,
        )
        return await self._aget_list_by_id_oapg(
    ...
    def get_list_by_id(
        ...
        return self._get_list_by_id_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetListById(BaseApi):
    ...
    async def aget_list_by_id(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_list_by_id(
            id_card=id_card,
            fields=fields,
            **kwargs,
        )
    ...
    def get_list_by_id(
        ...
        raw_response = self.raw.get_list_by_id(
            id_card=id_card,
            fields=fields,
        )
