...
class BaseApi(api_client.Api):
    ...
    def _get_members_by_filter_mapped_args(
        self,
        id_board: str,
        filter: str,
    ...
    async def _aget_members_by_filter_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/boards/{idBoard}/members/{filter}',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_members_by_filter_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetMembersByFilterRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_members_by_filter(
        self,
        id_board: str,
        filter: str,
        **kwargs,
        ...
        args = self._get_members_by_filter_mapped_args(
            id_board=id_board,
            filter=filter,
        )
        return await self._aget_members_by_filter_oapg(
    ...
    def get_members_by_filter(
        ...
        return self._get_members_by_filter_oapg(
            path_params=args.path,
        )

class GetMembersByFilter(BaseApi):
    ...
    async def aget_members_by_filter(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_members_by_filter(
            id_board=id_board,
            filter=filter,
            **kwargs,
        )
    ...
    def get_members_by_filter(
        ...
        raw_response = self.raw.get_members_by_filter(
            id_board=id_board,
            filter=filter,
        )
