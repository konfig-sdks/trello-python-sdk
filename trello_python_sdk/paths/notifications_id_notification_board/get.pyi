...
class BaseApi(api_client.Api):
    ...
    def _get_board_by_id_mapped_args(
        self,
        id_notification: str,
    ...
    async def _aget_board_by_id_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/notifications/{idNotification}/board',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetBoardByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_board_by_id(
        self,
        id_notification: str,
        fields: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._get_board_by_id_mapped_args(
            id_notification=id_notification,
            fields=fields,
        )
        return await self._aget_board_by_id_oapg(
    ...
    def get_board_by_id(
        ...
        return self._get_board_by_id_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetBoardById(BaseApi):
    ...
    async def aget_board_by_id(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_board_by_id(
            id_notification=id_notification,
            fields=fields,
            **kwargs,
        )
    ...
    def get_board_by_id(
        ...
        raw_response = self.raw.get_board_by_id(
            id_notification=id_notification,
            fields=fields,
        )
