...
class BaseApi(api_client.Api):
    ...
    def _list_labels_by_id_board_mapped_args(
        self,
        id_board: str,
    ...
    async def _alist_labels_by_id_board_oapg(
        self,
    ...
    def _list_labels_by_id_board_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class ListLabelsByIdBoardRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_labels_by_id_board(
        self,
        id_board: str,
        fields: typing.Optional[str] = None,
        limit: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._list_labels_by_id_board_mapped_args(
            id_board=id_board,
            fields=fields,
            limit=limit,
        )
        return await self._alist_labels_by_id_board_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def list_labels_by_id_board(
        self,
        id_board: str,
        fields: typing.Optional[str] = None,
        limit: typing.Optional[str] = None,
        ...
        return self._list_labels_by_id_board_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class ListLabelsByIdBoard(BaseApi):
    ...
    async def alist_labels_by_id_board(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.alist_labels_by_id_board(
            id_board=id_board,
            fields=fields,
            limit=limit,
            **kwargs,
    ...
    def list_labels_by_id_board(
        ...
        raw_response = self.raw.list_labels_by_id_board(
            id_board=id_board,
            fields=fields,
            limit=limit,
        )
