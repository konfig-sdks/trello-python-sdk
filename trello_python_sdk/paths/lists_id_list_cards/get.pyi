...
class BaseApi(api_client.Api):
    ...
    def _get_cards_by_id_list_mapped_args(
        self,
        id_list: str,
    ...
    async def _aget_cards_by_id_list_oapg(
        self,
    ...
    def _get_cards_by_id_list_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetCardsByIdListRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_cards_by_id_list(
        self,
        id_list: str,
        actions: typing.Optional[str] = None,
        attachments: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._get_cards_by_id_list_mapped_args(
            id_list=id_list,
            actions=actions,
        ...
        return await self._aget_cards_by_id_list_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def get_cards_by_id_list(
        self,
        id_list: str,
        actions: typing.Optional[str] = None,
        attachments: typing.Optional[str] = None,
        ...
        return self._get_cards_by_id_list_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetCardsByIdList(BaseApi):
    ...
    async def aget_cards_by_id_list(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_cards_by_id_list(
            id_list=id_list,
            actions=actions,
            attachments=attachments,
            attachment_fields=attachment_fields,
    ...
    def get_cards_by_id_list(
        ...
        raw_response = self.raw.get_cards_by_id_list(
            id_list=id_list,
            actions=actions,
            attachments=attachments,
            attachment_fields=attachment_fields,
