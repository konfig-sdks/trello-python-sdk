...
class BaseApi(api_client.Api):
    ...
    def _get_saved_search_by_ids_mapped_args(
        self,
        id_member: str,
        id_saved_search: str,
    ...
    async def _aget_saved_search_by_ids_oapg(
        self,
    ...
    def _get_saved_search_by_ids_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetSavedSearchByIdsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_saved_search_by_ids(
        self,
        id_member: str,
        id_saved_search: str,
        **kwargs,
        ...
        args = self._get_saved_search_by_ids_mapped_args(
            id_member=id_member,
            id_saved_search=id_saved_search,
        )
        return await self._aget_saved_search_by_ids_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def get_saved_search_by_ids(
        self,
        id_member: str,
        id_saved_search: str,
    ) -> typing.Union[
        ...
        return self._get_saved_search_by_ids_oapg(
            path_params=args.path,
        )

class GetSavedSearchByIds(BaseApi):
    ...
    async def aget_saved_search_by_ids(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_saved_search_by_ids(
            id_member=id_member,
            id_saved_search=id_saved_search,
            **kwargs,
        )
    ...
    def get_saved_search_by_ids(
        ...
        raw_response = self.raw.get_saved_search_by_ids(
            id_member=id_member,
            id_saved_search=id_saved_search,
        )
