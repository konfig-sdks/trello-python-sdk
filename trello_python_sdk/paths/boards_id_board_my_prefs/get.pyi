...
class BaseApi(api_client.Api):
    ...
    def _get_my_prefs_by_id_mapped_args(
        self,
        id_board: str,
    ...
    async def _aget_my_prefs_by_id_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/boards/{idBoard}/myPrefs',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetMyPrefsByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_my_prefs_by_id(
        self,
        id_board: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_my_prefs_by_id_mapped_args(
            id_board=id_board,
        )
        return await self._aget_my_prefs_by_id_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def get_my_prefs_by_id(
        self,
        id_board: str,
    ) -> typing.Union[
        ApiResponseFor200,
        ...
        return self._get_my_prefs_by_id_oapg(
            path_params=args.path,
        )

class GetMyPrefsById(BaseApi):
    ...
    async def aget_my_prefs_by_id(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_my_prefs_by_id(
            id_board=id_board,
            **kwargs,
        )
    ...
    def get_my_prefs_by_id(
        ...
        raw_response = self.raw.get_my_prefs_by_id(
            id_board=id_board,
        )
