...
ReadFilterSchema = schemas.StrSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'read_filter': typing.Union[ReadFilterSchema, str, ],
...
request_query_read_filter = api_client.QueryParameter(
    name="read_filter",
    style=api_client.ParameterStyle.FORM,
    schema=ReadFilterSchema,
    explode=True,
)
...
class BaseApi(api_client.Api):
    ...
    def _get_notifications_by_id_member_mapped_args(
        self,
        id_member: str,
        entities: typing.Optional[str] = None,
        display: typing.Optional[str] = None,
        filter: typing.Optional[str] = None,
        read_filter: typing.Optional[str] = None,
        ...
        if read_filter is not None:
            _query_params["read_filter"] = read_filter
    ...
    async def _aget_notifications_by_id_member_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/members/{idMember}/notifications',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_notifications_by_id_member_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetNotificationsByIdMemberRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_notifications_by_id_member(
        self,
        id_member: str,
        entities: typing.Optional[str] = None,
        display: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._get_notifications_by_id_member_mapped_args(
            id_member=id_member,
            entities=entities,
            display=display,
            filter=filter,
        ...
        return await self._aget_notifications_by_id_member_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def get_notifications_by_id_member(
        self,
        id_member: str,
        entities: typing.Optional[str] = None,
        display: typing.Optional[str] = None,
        ...
        return self._get_notifications_by_id_member_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetNotificationsByIdMember(BaseApi):
    ...
    async def aget_notifications_by_id_member(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_notifications_by_id_member(
            id_member=id_member,
            entities=entities,
            display=display,
            filter=filter,
    ...
    def get_notifications_by_id_member(
        ...
        raw_response = self.raw.get_notifications_by_id_member(
            id_member=id_member,
            entities=entities,
            display=display,
            filter=filter,
