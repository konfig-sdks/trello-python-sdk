...
class BaseApi(api_client.Api):
    ...
    def _remove_member_by_id_member_mapped_args(
        self,
        id_card: str,
        id_member: str,
    ...
    async def _aremove_member_by_id_member_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/cards/{idCard}/idMembers/{idMember}',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _remove_member_by_id_member_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class RemoveMemberByIdMemberRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aremove_member_by_id_member(
        self,
        id_card: str,
        id_member: str,
        **kwargs,
        ...
        args = self._remove_member_by_id_member_mapped_args(
            id_card=id_card,
            id_member=id_member,
        )
        return await self._aremove_member_by_id_member_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def remove_member_by_id_member(
        self,
        id_card: str,
        id_member: str,
    ) -> typing.Union[
        ...
        return self._remove_member_by_id_member_oapg(
            path_params=args.path,
        )

class RemoveMemberByIdMember(BaseApi):
    ...
    async def aremove_member_by_id_member(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aremove_member_by_id_member(
            id_card=id_card,
            id_member=id_member,
            **kwargs,
        )
    ...
    def remove_member_by_id_member(
        ...
        raw_response = self.raw.remove_member_by_id_member(
            id_card=id_card,
            id_member=id_member,
        )
