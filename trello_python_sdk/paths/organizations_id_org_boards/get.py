...
class BaseApi(api_client.Api):
    ...
    def _get_boards_by_org_id_mapped_args(
        self,
        id_org: str,
    ...
    async def _aget_boards_by_org_id_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/organizations/{idOrg}/boards',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_boards_by_org_id_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetBoardsByOrgIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_boards_by_org_id(
        self,
        id_org: str,
        filter: typing.Optional[str] = None,
        fields: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._get_boards_by_org_id_mapped_args(
            id_org=id_org,
            filter=filter,
            fields=fields,
            actions=actions,
        ...
        return await self._aget_boards_by_org_id_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def get_boards_by_org_id(
        self,
        id_org: str,
        filter: typing.Optional[str] = None,
        fields: typing.Optional[str] = None,
        ...
        return self._get_boards_by_org_id_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetBoardsByOrgId(BaseApi):
    ...
    async def aget_boards_by_org_id(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_boards_by_org_id(
            id_org=id_org,
            filter=filter,
            fields=fields,
            actions=actions,
    ...
    def get_boards_by_org_id(
        ...
        raw_response = self.raw.get_boards_by_org_id(
            id_org=id_org,
            filter=filter,
            fields=fields,
            actions=actions,
