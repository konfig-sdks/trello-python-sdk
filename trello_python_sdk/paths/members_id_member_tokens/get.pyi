...
class BaseApi(api_client.Api):
    ...
    def _get_tokens_by_id_member_mapped_args(
        self,
        id_member: str,
    ...
    async def _aget_tokens_by_id_member_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/members/{idMember}/tokens',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_tokens_by_id_member_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetTokensByIdMemberRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_tokens_by_id_member(
        self,
        id_member: str,
        filter: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._get_tokens_by_id_member_mapped_args(
            id_member=id_member,
            filter=filter,
        )
        return await self._aget_tokens_by_id_member_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def get_tokens_by_id_member(
        self,
        id_member: str,
        filter: typing.Optional[str] = None,
    ) -> typing.Union[
        ...
        return self._get_tokens_by_id_member_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetTokensByIdMember(BaseApi):
    ...
    async def aget_tokens_by_id_member(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_tokens_by_id_member(
            id_member=id_member,
            filter=filter,
            **kwargs,
        )
    ...
    def get_tokens_by_id_member(
        ...
        raw_response = self.raw.get_tokens_by_id_member(
            id_member=id_member,
            filter=filter,
        )
