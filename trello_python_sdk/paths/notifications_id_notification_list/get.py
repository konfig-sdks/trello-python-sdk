...
class BaseApi(api_client.Api):
    ...
    def _get_list_by_id_notification_mapped_args(
        self,
        id_notification: str,
    ...
    async def _aget_list_by_id_notification_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/notifications/{idNotification}/list',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_list_by_id_notification_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetListByIdNotificationRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_list_by_id_notification(
        self,
        id_notification: str,
        fields: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._get_list_by_id_notification_mapped_args(
            id_notification=id_notification,
            fields=fields,
        )
        return await self._aget_list_by_id_notification_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def get_list_by_id_notification(
        self,
        id_notification: str,
        fields: typing.Optional[str] = None,
    ) -> typing.Union[
        ...
        return self._get_list_by_id_notification_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetListByIdNotification(BaseApi):
    ...
    async def aget_list_by_id_notification(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_list_by_id_notification(
            id_notification=id_notification,
            fields=fields,
            **kwargs,
        )
    ...
    def get_list_by_id_notification(
        ...
        raw_response = self.raw.get_list_by_id_notification(
            id_notification=id_notification,
            fields=fields,
        )
