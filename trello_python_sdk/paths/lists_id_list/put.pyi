...
class BaseApi(api_client.Api):
    ...
    def _update_by_id_list_mapped_args(
        self,
        id_list: str,
    ...
    async def _aupdate_by_id_list_oapg(
        self,
...
class UpdateByIdListRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_by_id_list(
        self,
        id_list: str,
        closed: typing.Optional[str] = None,
        id_board: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._update_by_id_list_mapped_args(
            id_list=id_list,
            closed=closed,
            id_board=id_board,
        ...
        return await self._aupdate_by_id_list_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def update_by_id_list(
        self,
        id_list: str,
        closed: typing.Optional[str] = None,
        id_board: typing.Optional[str] = None,
        ...
        return self._update_by_id_list_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdateByIdList(BaseApi):
    ...
    async def aupdate_by_id_list(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_by_id_list(
            id_list=id_list,
            closed=closed,
            id_board=id_board,
            id_list_source=id_list_source,
    ...
    def update_by_id_list(
        ...
        raw_response = self.raw.update_by_id_list(
            id_list=id_list,
            closed=closed,
            id_board=id_board,
            id_list_source=id_list_source,
