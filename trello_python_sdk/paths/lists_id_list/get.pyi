...
class BaseApi(api_client.Api):
    ...
    def _get_by_id_list_mapped_args(
        self,
        id_list: str,
    ...
    async def _aget_by_id_list_oapg(
        self,
...
class GetByIdListRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_by_id_list(
        self,
        id_list: str,
        cards: typing.Optional[str] = None,
        card_fields: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._get_by_id_list_mapped_args(
            id_list=id_list,
            cards=cards,
        ...
        return await self._aget_by_id_list_oapg(
    ...
    def get_by_id_list(
        ...
        return self._get_by_id_list_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetByIdList(BaseApi):
    ...
    async def aget_by_id_list(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_by_id_list(
            id_list=id_list,
            cards=cards,
            card_fields=card_fields,
            board=board,
    ...
    def get_by_id_list(
        ...
        raw_response = self.raw.get_by_id_list(
            id_list=id_list,
            cards=cards,
            card_fields=card_fields,
            board=board,
