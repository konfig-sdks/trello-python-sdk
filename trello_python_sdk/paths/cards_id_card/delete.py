...
class BaseApi(api_client.Api):
    ...
    def _remove_by_id_card_mapped_args(
        self,
        id_card: str,
    ...
    async def _aremove_by_id_card_oapg(
        self,
...
class RemoveByIdCardRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aremove_by_id_card(
        self,
        id_card: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._remove_by_id_card_mapped_args(
            id_card=id_card,
        )
        return await self._aremove_by_id_card_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def remove_by_id_card(
        self,
        id_card: str,
    ) -> typing.Union[
        ApiResponseFor200,
        ...
        return self._remove_by_id_card_oapg(
            path_params=args.path,
        )

class RemoveByIdCard(BaseApi):
    ...
    async def aremove_by_id_card(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aremove_by_id_card(
            id_card=id_card,
            **kwargs,
        )
    ...
    def remove_by_id_card(
        ...
        raw_response = self.raw.remove_by_id_card(
            id_card=id_card,
        )
