...
MembersVotedSchema = schemas.StrSchema
MemberVotedFieldsSchema = schemas.StrSchema
CheckItemStatesSchema = schemas.StrSchema
CheckItemStateFieldsSchema = schemas.StrSchema
...
StickerFieldsSchema = schemas.StrSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'membersVoted': typing.Union[MembersVotedSchema, str, ],
        'memberVoted_fields': typing.Union[MemberVotedFieldsSchema, str, ],
        'checkItemStates': typing.Union[CheckItemStatesSchema, str, ],
        'checkItemState_fields': typing.Union[CheckItemStateFieldsSchema, str, ],
        ...
        'sticker_fields': typing.Union[StickerFieldsSchema, str, ],
...
request_query_members_voted = api_client.QueryParameter(
    name="membersVoted",
    style=api_client.ParameterStyle.FORM,
    schema=MembersVotedSchema,
    explode=True,
)
request_query_member_voted_fields = api_client.QueryParameter(
    name="memberVoted_fields",
    style=api_client.ParameterStyle.FORM,
    schema=MemberVotedFieldsSchema,
    explode=True,
)
...
request_query_check_item_state_fields = api_client.QueryParameter(
    name="checkItemState_fields",
    style=api_client.ParameterStyle.FORM,
    schema=CheckItemStateFieldsSchema,
    explode=True,
)
...
request_query_sticker_fields = api_client.QueryParameter(
    name="sticker_fields",
    style=api_client.ParameterStyle.FORM,
    schema=StickerFieldsSchema,
    explode=True,
)
...
class BaseApi(api_client.Api):
    ...
    def _get_by_id_mapped_args(
        ...
        members_voted: typing.Optional[str] = None,
        member_voted_fields: typing.Optional[str] = None,
        check_item_states: typing.Optional[str] = None,
        check_item_state_fields: typing.Optional[str] = None,
        ...
        sticker_fields: typing.Optional[str] = None,
        ...
        if members_voted is not None:
            _query_params["membersVoted"] = members_voted
        if member_voted_fields is not None:
            _query_params["memberVoted_fields"] = member_voted_fields
        if check_item_states is not None:
            _query_params["checkItemStates"] = check_item_states
        if check_item_state_fields is not None:
            _query_params["checkItemState_fields"] = check_item_state_fields
        ...
        if sticker_fields is not None:
            _query_params["sticker_fields"] = sticker_fields
    ...
    async def _aget_by_id_oapg(
        ...
        **kwargs,
        ...
        for parameter in (
            ...
            request_query_members_voted,
            request_query_member_voted_fields,
            request_query_check_item_states,
            request_query_check_item_state_fields,
