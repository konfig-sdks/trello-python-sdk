...
class BaseApi(api_client.Api):
    ...
    def _list_organizations_by_id_mapped_args(
        self,
        id_member: str,
    ...
    async def _alist_organizations_by_id_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/members/{idMember}/organizations',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _list_organizations_by_id_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class ListOrganizationsByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_organizations_by_id(
        self,
        id_member: str,
        filter: typing.Optional[str] = None,
        fields: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._list_organizations_by_id_mapped_args(
            id_member=id_member,
            filter=filter,
            fields=fields,
            paid_account=paid_account,
        )
        return await self._alist_organizations_by_id_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def list_organizations_by_id(
        self,
        id_member: str,
        filter: typing.Optional[str] = None,
        fields: typing.Optional[str] = None,
        ...
        return self._list_organizations_by_id_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class ListOrganizationsById(BaseApi):
    ...
    async def alist_organizations_by_id(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.alist_organizations_by_id(
            id_member=id_member,
            filter=filter,
            fields=fields,
            paid_account=paid_account,
    ...
    def list_organizations_by_id(
        ...
        raw_response = self.raw.list_organizations_by_id(
            id_member=id_member,
            filter=filter,
            fields=fields,
            paid_account=paid_account,
