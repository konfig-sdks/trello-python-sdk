...
class BaseApi(api_client.Api):
    ...
    def _get_checklists_by_id_mapped_args(
        self,
        id_board: str,
    ...
    async def _aget_checklists_by_id_oapg(
        self,
    ...
    def _get_checklists_by_id_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetChecklistsByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_checklists_by_id(
        self,
        id_board: str,
        cards: typing.Optional[str] = None,
        card_fields: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._get_checklists_by_id_mapped_args(
            id_board=id_board,
            cards=cards,
        ...
        return await self._aget_checklists_by_id_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def get_checklists_by_id(
        self,
        id_board: str,
        cards: typing.Optional[str] = None,
        card_fields: typing.Optional[str] = None,
        ...
        return self._get_checklists_by_id_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetChecklistsById(BaseApi):
    ...
    async def aget_checklists_by_id(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_checklists_by_id(
            id_board=id_board,
            cards=cards,
            card_fields=card_fields,
            check_items=check_items,
    ...
    def get_checklists_by_id(
        ...
        raw_response = self.raw.get_checklists_by_id(
            id_board=id_board,
            cards=cards,
            card_fields=card_fields,
            check_items=check_items,
