...
class BaseApi(api_client.Api):
    ...
    def _get_cards_by_id_board_by_id_card_mapped_args(
        self,
        id_board: str,
        id_card: str,
    ...
    async def _aget_cards_by_id_board_by_id_card_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/boards/{idBoard}/cards/{idCard}',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_cards_by_id_board_by_id_card_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetCardsByIdBoardByIdCardRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_cards_by_id_board_by_id_card(
        self,
        id_board: str,
        id_card: str,
        attachments: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._get_cards_by_id_board_by_id_card_mapped_args(
            id_board=id_board,
            id_card=id_card,
        ...
        return await self._aget_cards_by_id_board_by_id_card_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def get_cards_by_id_board_by_id_card(
        self,
        id_board: str,
        id_card: str,
        attachments: typing.Optional[str] = None,
        ...
        return self._get_cards_by_id_board_by_id_card_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetCardsByIdBoardByIdCard(BaseApi):
    ...
    async def aget_cards_by_id_board_by_id_card(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_cards_by_id_board_by_id_card(
            id_board=id_board,
            id_card=id_card,
            attachments=attachments,
            attachment_fields=attachment_fields,
    ...
    def get_cards_by_id_board_by_id_card(
        ...
        raw_response = self.raw.get_cards_by_id_board_by_id_card(
            id_board=id_board,
            id_card=id_card,
            attachments=attachments,
            attachment_fields=attachment_fields,
