...
class BaseApi(api_client.Api):
    ...
    def _list_custom_emoji_by_id_member_mapped_args(
        self,
        id_member: str,
    ...
    async def _alist_custom_emoji_by_id_member_oapg(
        self,
    ...
    def _list_custom_emoji_by_id_member_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class ListCustomEmojiByIdMemberRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_custom_emoji_by_id_member(
        self,
        id_member: str,
        filter: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._list_custom_emoji_by_id_member_mapped_args(
            id_member=id_member,
            filter=filter,
        )
        return await self._alist_custom_emoji_by_id_member_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def list_custom_emoji_by_id_member(
        self,
        id_member: str,
        filter: typing.Optional[str] = None,
    ) -> typing.Union[
        ...
        return self._list_custom_emoji_by_id_member_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class ListCustomEmojiByIdMember(BaseApi):
    ...
    async def alist_custom_emoji_by_id_member(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.alist_custom_emoji_by_id_member(
            id_member=id_member,
            filter=filter,
            **kwargs,
        )
    ...
    def list_custom_emoji_by_id_member(
        ...
        raw_response = self.raw.list_custom_emoji_by_id_member(
            id_member=id_member,
            filter=filter,
        )
