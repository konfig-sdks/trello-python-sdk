    ...
    async def _aid_board_get_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/lists/{idList}/board',
            auth_settings=_auth,
            headers=_headers,
        )
...
class IdBoardGetRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aid_board_get(
        self,
        id_list: str,
        fields: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._id_board_get_mapped_args(
            id_list=id_list,
            fields=fields,
        )
        return await self._aid_board_get_oapg(
    ...
    def id_board_get(
        ...
        return self._id_board_get_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class IdBoardGet(BaseApi):
    ...
    async def aid_board_get(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aid_board_get(
            id_list=id_list,
            fields=fields,
            **kwargs,
        )
    ...
    def id_board_get(
        ...
        raw_response = self.raw.id_board_get(
            id_list=id_list,
            fields=fields,
        )
