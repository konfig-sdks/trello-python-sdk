...
class BaseApi(api_client.Api):
    ...
    def _update_members_by_id_board_mapped_args(
        self,
        id_board: str,
    ...
    async def _aupdate_members_by_id_board_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/boards/{idBoard}/members',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _update_members_by_id_board_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class UpdateMembersByIdBoardRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_members_by_id_board(
        self,
        id_board: str,
        email: typing.Optional[str] = None,
        full_name: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._update_members_by_id_board_mapped_args(
            id_board=id_board,
            email=email,
            full_name=full_name,
            type=type,
        )
        return await self._aupdate_members_by_id_board_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def update_members_by_id_board(
        self,
        id_board: str,
        email: typing.Optional[str] = None,
        full_name: typing.Optional[str] = None,
        ...
        return self._update_members_by_id_board_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdateMembersByIdBoard(BaseApi):
    ...
    async def aupdate_members_by_id_board(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_members_by_id_board(
            id_board=id_board,
            email=email,
            full_name=full_name,
            type=type,
    ...
    def update_members_by_id_board(
        ...
        raw_response = self.raw.update_members_by_id_board(
            id_board=id_board,
            email=email,
            full_name=full_name,
            type=type,
