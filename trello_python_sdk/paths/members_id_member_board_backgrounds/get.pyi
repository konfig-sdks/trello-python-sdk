...
class BaseApi(api_client.Api):
    ...
    def _get_board_backgrounds_by_id_mapped_args(
        self,
        id_member: str,
    ...
    async def _aget_board_backgrounds_by_id_oapg(
        self,
    ...
    def _get_board_backgrounds_by_id_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetBoardBackgroundsByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_board_backgrounds_by_id(
        self,
        id_member: str,
        filter: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._get_board_backgrounds_by_id_mapped_args(
            id_member=id_member,
            filter=filter,
        )
        return await self._aget_board_backgrounds_by_id_oapg(
    ...
    def get_board_backgrounds_by_id(
        ...
        return self._get_board_backgrounds_by_id_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetBoardBackgroundsById(BaseApi):
    ...
    async def aget_board_backgrounds_by_id(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_board_backgrounds_by_id(
            id_member=id_member,
            filter=filter,
            **kwargs,
        )
    ...
    def get_board_backgrounds_by_id(
        ...
        raw_response = self.raw.get_board_backgrounds_by_id(
            id_member=id_member,
            filter=filter,
        )
