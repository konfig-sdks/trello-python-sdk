...
class BaseApi(api_client.Api):
    ...
    def _get_organization_by_id_mapped_args(
        self,
        id_board: str,
    ...
    async def _aget_organization_by_id_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/boards/{idBoard}/organization',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetOrganizationByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_organization_by_id(
        self,
        id_board: str,
        fields: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._get_organization_by_id_mapped_args(
            id_board=id_board,
            fields=fields,
        )
        return await self._aget_organization_by_id_oapg(
...
class GetOrganizationById(BaseApi):
    ...
    async def aget_organization_by_id(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_organization_by_id(
            id_board=id_board,
            fields=fields,
            **kwargs,
        )
    ...
    def get_organization_by_id(
        ...
        raw_response = self.raw.get_organization_by_id(
            id_board=id_board,
            fields=fields,
        )
