...
class BaseApi(api_client.Api):
    ...
    def _get_memberships_by_id_board_mapped_args(
        self,
        id_board: str,
    ...
    async def _aget_memberships_by_id_board_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/boards/{idBoard}/memberships',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_memberships_by_id_board_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetMembershipsByIdBoardRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_memberships_by_id_board(
        self,
        id_board: str,
        filter: typing.Optional[str] = None,
        member: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._get_memberships_by_id_board_mapped_args(
            id_board=id_board,
            filter=filter,
            member=member,
            member_fields=member_fields,
        )
        return await self._aget_memberships_by_id_board_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def get_memberships_by_id_board(
        self,
        id_board: str,
        filter: typing.Optional[str] = None,
        member: typing.Optional[str] = None,
        ...
        return self._get_memberships_by_id_board_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetMembershipsByIdBoard(BaseApi):
    ...
    async def aget_memberships_by_id_board(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_memberships_by_id_board(
            id_board=id_board,
            filter=filter,
            member=member,
            member_fields=member_fields,
    ...
    def get_memberships_by_id_board(
        ...
        raw_response = self.raw.get_memberships_by_id_board(
            id_board=id_board,
            filter=filter,
            member=member,
            member_fields=member_fields,
