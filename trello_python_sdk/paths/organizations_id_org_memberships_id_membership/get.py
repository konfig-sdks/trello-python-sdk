...
class BaseApi(api_client.Api):
    ...
    def _get_memberships_by_id_org_by_id_membership_mapped_args(
        self,
        id_org: str,
        id_membership: str,
    ...
    async def _aget_memberships_by_id_org_by_id_membership_oapg(
        self,
    ...
    def _get_memberships_by_id_org_by_id_membership_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetMembershipsByIdOrgByIdMembershipRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_memberships_by_id_org_by_id_membership(
        self,
        id_org: str,
        id_membership: str,
        member: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._get_memberships_by_id_org_by_id_membership_mapped_args(
            id_org=id_org,
            id_membership=id_membership,
            member=member,
            member_fields=member_fields,
        )
        return await self._aget_memberships_by_id_org_by_id_membership_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def get_memberships_by_id_org_by_id_membership(
        self,
        id_org: str,
        id_membership: str,
        member: typing.Optional[str] = None,
        ...
        return self._get_memberships_by_id_org_by_id_membership_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetMembershipsByIdOrgByIdMembership(BaseApi):
    ...
    async def aget_memberships_by_id_org_by_id_membership(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_memberships_by_id_org_by_id_membership(
            id_org=id_org,
            id_membership=id_membership,
            member=member,
            member_fields=member_fields,
    ...
    def get_memberships_by_id_org_by_id_membership(
        ...
        raw_response = self.raw.get_memberships_by_id_org_by_id_membership(
            id_org=id_org,
            id_membership=id_membership,
            member=member,
            member_fields=member_fields,
