...
class BaseApi(api_client.Api):
    ...
    def _remove_by_id_org_mapped_args(
        self,
        id_org: str,
    ...
    async def _aremove_by_id_org_oapg(
        self,
...
class RemoveByIdOrgRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aremove_by_id_org(
        self,
        id_org: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._remove_by_id_org_mapped_args(
            id_org=id_org,
        )
        return await self._aremove_by_id_org_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def remove_by_id_org(
        self,
        id_org: str,
    ) -> typing.Union[
        ApiResponseFor200,
        ...
        return self._remove_by_id_org_oapg(
            path_params=args.path,
        )

class RemoveByIdOrg(BaseApi):
    ...
    async def aremove_by_id_org(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aremove_by_id_org(
            id_org=id_org,
            **kwargs,
        )
    ...
    def remove_by_id_org(
        ...
        raw_response = self.raw.remove_by_id_org(
            id_org=id_org,
        )
