...
class BaseApi(api_client.Api):
    ...
    def _get_board_by_id_label_mapped_args(
        self,
        id_label: str,
    ...
    async def _aget_board_by_id_label_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/labels/{idLabel}/board',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_board_by_id_label_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetBoardByIdLabelRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_board_by_id_label(
        self,
        id_label: str,
        fields: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._get_board_by_id_label_mapped_args(
            id_label=id_label,
            fields=fields,
        )
        return await self._aget_board_by_id_label_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def get_board_by_id_label(
        self,
        id_label: str,
        fields: typing.Optional[str] = None,
    ) -> typing.Union[
        ...
        return self._get_board_by_id_label_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetBoardByIdLabel(BaseApi):
    ...
    async def aget_board_by_id_label(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_board_by_id_label(
            id_label=id_label,
            fields=fields,
            **kwargs,
        )
    ...
    def get_board_by_id_label(
        ...
        raw_response = self.raw.get_board_by_id_label(
            id_label=id_label,
            fields=fields,
        )
