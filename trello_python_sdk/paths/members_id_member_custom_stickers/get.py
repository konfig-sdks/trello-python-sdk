...
class BaseApi(api_client.Api):
    ...
    def _get_custom_stickers_by_id_member_mapped_args(
        self,
        id_member: str,
    ...
    async def _aget_custom_stickers_by_id_member_oapg(
        self,
    ...
    def _get_custom_stickers_by_id_member_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetCustomStickersByIdMemberRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_custom_stickers_by_id_member(
        self,
        id_member: str,
        filter: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._get_custom_stickers_by_id_member_mapped_args(
            id_member=id_member,
            filter=filter,
        )
        return await self._aget_custom_stickers_by_id_member_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def get_custom_stickers_by_id_member(
        self,
        id_member: str,
        filter: typing.Optional[str] = None,
    ) -> typing.Union[
        ...
        return self._get_custom_stickers_by_id_member_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetCustomStickersByIdMember(BaseApi):
    ...
    async def aget_custom_stickers_by_id_member(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_custom_stickers_by_id_member(
            id_member=id_member,
            filter=filter,
            **kwargs,
        )
    ...
    def get_custom_stickers_by_id_member(
        ...
        raw_response = self.raw.get_custom_stickers_by_id_member(
            id_member=id_member,
            filter=filter,
        )
