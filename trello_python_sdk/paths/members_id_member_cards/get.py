...
class BaseApi(api_client.Api):
    ...
    def _get_cards_by_id_member_mapped_args(
        self,
        id_member: str,
    ...
    async def _aget_cards_by_id_member_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/members/{idMember}/cards',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_cards_by_id_member_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetCardsByIdMemberRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_cards_by_id_member(
        self,
        id_member: str,
        actions: typing.Optional[str] = None,
        attachments: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._get_cards_by_id_member_mapped_args(
            id_member=id_member,
            actions=actions,
        ...
        return await self._aget_cards_by_id_member_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def get_cards_by_id_member(
        self,
        id_member: str,
        actions: typing.Optional[str] = None,
        attachments: typing.Optional[str] = None,
        ...
        return self._get_cards_by_id_member_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetCardsByIdMember(BaseApi):
    ...
    async def aget_cards_by_id_member(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_cards_by_id_member(
            id_member=id_member,
            actions=actions,
            attachments=attachments,
            attachment_fields=attachment_fields,
    ...
    def get_cards_by_id_member(
        ...
        raw_response = self.raw.get_cards_by_id_member(
            id_member=id_member,
            actions=actions,
            attachments=attachments,
            attachment_fields=attachment_fields,
