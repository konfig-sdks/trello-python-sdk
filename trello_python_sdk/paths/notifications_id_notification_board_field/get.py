...
class BaseApi(api_client.Api):
    ...
    def _get_board_by_field_mapped_args(
        self,
        id_notification: str,
        field: str,
    ...
    async def _aget_board_by_field_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/notifications/{idNotification}/board/{field}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetBoardByFieldRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_board_by_field(
        self,
        id_notification: str,
        field: str,
        **kwargs,
        ...
        args = self._get_board_by_field_mapped_args(
            id_notification=id_notification,
            field=field,
        )
        return await self._aget_board_by_field_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def get_board_by_field(
        self,
        id_notification: str,
        field: str,
    ) -> typing.Union[
        ...
        return self._get_board_by_field_oapg(
            path_params=args.path,
        )

class GetBoardByField(BaseApi):
    ...
    async def aget_board_by_field(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_board_by_field(
            id_notification=id_notification,
            field=field,
            **kwargs,
        )
    ...
    def get_board_by_field(
        ...
        raw_response = self.raw.get_board_by_field(
            id_notification=id_notification,
            field=field,
        )
