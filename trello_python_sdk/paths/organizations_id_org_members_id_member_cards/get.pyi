...
class BaseApi(api_client.Api):
    ...
    def _list_members_cards_by_id_org_by_id_member_mapped_args(
        self,
        id_org: str,
        id_member: str,
    ...
    async def _alist_members_cards_by_id_org_by_id_member_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/organizations/{idOrg}/members/{idMember}/cards',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _list_members_cards_by_id_org_by_id_member_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class ListMembersCardsByIdOrgByIdMemberRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_members_cards_by_id_org_by_id_member(
        self,
        id_org: str,
        id_member: str,
        actions: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._list_members_cards_by_id_org_by_id_member_mapped_args(
            id_org=id_org,
            id_member=id_member,
            actions=actions,
        ...
        return await self._alist_members_cards_by_id_org_by_id_member_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def list_members_cards_by_id_org_by_id_member(
        self,
        id_org: str,
        id_member: str,
        actions: typing.Optional[str] = None,
        ...
        return self._list_members_cards_by_id_org_by_id_member_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class ListMembersCardsByIdOrgByIdMember(BaseApi):
    ...
    async def alist_members_cards_by_id_org_by_id_member(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.alist_members_cards_by_id_org_by_id_member(
            id_org=id_org,
            id_member=id_member,
            actions=actions,
            attachments=attachments,
    ...
    def list_members_cards_by_id_org_by_id_member(
        ...
        raw_response = self.raw.list_members_cards_by_id_org_by_id_member(
            id_org=id_org,
            id_member=id_member,
            actions=actions,
            attachments=attachments,
