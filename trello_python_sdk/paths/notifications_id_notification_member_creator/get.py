...
class BaseApi(api_client.Api):
    ...
    def _get_member_creator_by_id_mapped_args(
        self,
        id_notification: str,
    ...
    async def _aget_member_creator_by_id_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/notifications/{idNotification}/memberCreator',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_member_creator_by_id_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetMemberCreatorByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_member_creator_by_id(
        self,
        id_notification: str,
        fields: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._get_member_creator_by_id_mapped_args(
            id_notification=id_notification,
            fields=fields,
        )
        return await self._aget_member_creator_by_id_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def get_member_creator_by_id(
        self,
        id_notification: str,
        fields: typing.Optional[str] = None,
    ) -> typing.Union[
        ...
        return self._get_member_creator_by_id_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetMemberCreatorById(BaseApi):
    ...
    async def aget_member_creator_by_id(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_member_creator_by_id(
            id_notification=id_notification,
            fields=fields,
            **kwargs,
        )
    ...
    def get_member_creator_by_id(
        ...
        raw_response = self.raw.get_member_creator_by_id(
            id_notification=id_notification,
            fields=fields,
        )
