...
class BaseApi(api_client.Api):
    ...
    def _get_memberships_by_id_board_by_id_membership_mapped_args(
        self,
        id_board: str,
        id_membership: str,
    ...
    async def _aget_memberships_by_id_board_by_id_membership_oapg(
        self,
    ...
    def _get_memberships_by_id_board_by_id_membership_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetMembershipsByIdBoardByIdMembershipRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_memberships_by_id_board_by_id_membership(
        self,
        id_board: str,
        id_membership: str,
        member: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._get_memberships_by_id_board_by_id_membership_mapped_args(
            id_board=id_board,
            id_membership=id_membership,
            member=member,
            member_fields=member_fields,
        )
        return await self._aget_memberships_by_id_board_by_id_membership_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def get_memberships_by_id_board_by_id_membership(
        self,
        id_board: str,
        id_membership: str,
        member: typing.Optional[str] = None,
        ...
        return self._get_memberships_by_id_board_by_id_membership_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetMembershipsByIdBoardByIdMembership(BaseApi):
    ...
    async def aget_memberships_by_id_board_by_id_membership(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_memberships_by_id_board_by_id_membership(
            id_board=id_board,
            id_membership=id_membership,
            member=member,
            member_fields=member_fields,
    ...
    def get_memberships_by_id_board_by_id_membership(
        ...
        raw_response = self.raw.get_memberships_by_id_board_by_id_membership(
            id_board=id_board,
            id_membership=id_membership,
            member=member,
            member_fields=member_fields,
