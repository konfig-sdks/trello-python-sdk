...
class BaseApi(api_client.Api):
    ...
    def _get_cards_by_filter_mapped_args(
        self,
        id_checklist: str,
        filter: str,
    ...
    async def _aget_cards_by_filter_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/checklists/{idChecklist}/cards/{filter}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetCardsByFilterRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_cards_by_filter(
        self,
        id_checklist: str,
        filter: str,
        **kwargs,
        ...
        args = self._get_cards_by_filter_mapped_args(
            id_checklist=id_checklist,
            filter=filter,
        )
        return await self._aget_cards_by_filter_oapg(
    ...
    def get_cards_by_filter(
        ...
        return self._get_cards_by_filter_oapg(
            path_params=args.path,
        )

class GetCardsByFilter(BaseApi):
    ...
    async def aget_cards_by_filter(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_cards_by_filter(
            id_checklist=id_checklist,
            filter=filter,
            **kwargs,
        )
    ...
    def get_cards_by_filter(
        ...
        raw_response = self.raw.get_cards_by_filter(
            id_checklist=id_checklist,
            filter=filter,
        )
