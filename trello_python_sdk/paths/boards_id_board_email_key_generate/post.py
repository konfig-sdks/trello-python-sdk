...
class BaseApi(api_client.Api):
    ...
    def _generate_email_key_mapped_args(
        self,
        id_board: str,
    ...
    async def _agenerate_email_key_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/boards/{idBoard}/emailKey/generate',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GenerateEmailKeyRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def agenerate_email_key(
        self,
        id_board: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._generate_email_key_mapped_args(
            id_board=id_board,
        )
        return await self._agenerate_email_key_oapg(
    ...
    def generate_email_key(
        ...
        return self._generate_email_key_oapg(
            path_params=args.path,
        )

class GenerateEmailKey(BaseApi):
    ...
    async def agenerate_email_key(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.agenerate_email_key(
            id_board=id_board,
            **kwargs,
        )
    ...
    def generate_email_key(
        ...
        raw_response = self.raw.generate_email_key(
            id_board=id_board,
        )
