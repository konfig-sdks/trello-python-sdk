...
class BaseApi(api_client.Api):
    ...
    def _get_lists_by_filter_mapped_args(
        self,
        id_board: str,
        filter: str,
    ...
    async def _aget_lists_by_filter_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/boards/{idBoard}/lists/{filter}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetListsByFilterRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_lists_by_filter(
        self,
        id_board: str,
        filter: str,
        **kwargs,
        ...
        args = self._get_lists_by_filter_mapped_args(
            id_board=id_board,
            filter=filter,
        )
        return await self._aget_lists_by_filter_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def get_lists_by_filter(
        self,
        id_board: str,
        filter: str,
    ) -> typing.Union[
        ...
        return self._get_lists_by_filter_oapg(
            path_params=args.path,
        )

class GetListsByFilter(BaseApi):
    ...
    async def aget_lists_by_filter(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_lists_by_filter(
            id_board=id_board,
            filter=filter,
            **kwargs,
        )
    ...
    def get_lists_by_filter(
        ...
        raw_response = self.raw.get_lists_by_filter(
            id_board=id_board,
            filter=filter,
        )
