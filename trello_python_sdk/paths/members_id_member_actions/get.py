...
class BaseApi(api_client.Api):
    ...
    def _list_actions_by_id_member_mapped_args(
        self,
        id_member: str,
    ...
    async def _alist_actions_by_id_member_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/members/{idMember}/actions',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _list_actions_by_id_member_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class ListActionsByIdMemberRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_actions_by_id_member(
        self,
        id_member: str,
        entities: typing.Optional[str] = None,
        display: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._list_actions_by_id_member_mapped_args(
            id_member=id_member,
            entities=entities,
            display=display,
            filter=filter,
        ...
        return await self._alist_actions_by_id_member_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def list_actions_by_id_member(
        self,
        id_member: str,
        entities: typing.Optional[str] = None,
        display: typing.Optional[str] = None,
        ...
        return self._list_actions_by_id_member_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class ListActionsByIdMember(BaseApi):
    ...
    async def alist_actions_by_id_member(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.alist_actions_by_id_member(
            id_member=id_member,
            entities=entities,
            display=display,
            filter=filter,
    ...
    def list_actions_by_id_member(
        ...
        raw_response = self.raw.list_actions_by_id_member(
            id_member=id_member,
            entities=entities,
            display=display,
            filter=filter,
