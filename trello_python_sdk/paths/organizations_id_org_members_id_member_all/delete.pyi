...
class BaseApi(api_client.Api):
    ...
    def _remove_member_all_mapped_args(
        self,
        id_org: str,
        id_member: str,
    ...
    async def _aremove_member_all_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/organizations/{idOrg}/members/{idMember}/all',
            auth_settings=_auth,
            headers=_headers,
        )
...
class RemoveMemberAllRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aremove_member_all(
        self,
        id_org: str,
        id_member: str,
        **kwargs,
        ...
        args = self._remove_member_all_mapped_args(
            id_org=id_org,
            id_member=id_member,
        )
        return await self._aremove_member_all_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def remove_member_all(
        self,
        id_org: str,
        id_member: str,
    ) -> typing.Union[
        ...
        return self._remove_member_all_oapg(
            path_params=args.path,
        )

class RemoveMemberAll(BaseApi):
    ...
    async def aremove_member_all(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aremove_member_all(
            id_org=id_org,
            id_member=id_member,
            **kwargs,
        )
    ...
    def remove_member_all(
        ...
        raw_response = self.raw.remove_member_all(
            id_org=id_org,
            id_member=id_member,
        )
