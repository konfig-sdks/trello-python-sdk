...
class BaseApi(api_client.Api):
    ...
    def _get_members_by_id_org_mapped_args(
        self,
        id_org: str,
    ...
    async def _aget_members_by_id_org_oapg(
        self,
    ...
    def _get_members_by_id_org_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetMembersByIdOrgRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_members_by_id_org(
        self,
        id_org: str,
        filter: typing.Optional[str] = None,
        fields: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._get_members_by_id_org_mapped_args(
            id_org=id_org,
            filter=filter,
            fields=fields,
            activity=activity,
        )
        return await self._aget_members_by_id_org_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def get_members_by_id_org(
        self,
        id_org: str,
        filter: typing.Optional[str] = None,
        fields: typing.Optional[str] = None,
        ...
        return self._get_members_by_id_org_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetMembersByIdOrg(BaseApi):
    ...
    async def aget_members_by_id_org(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_members_by_id_org(
            id_org=id_org,
            filter=filter,
            fields=fields,
            activity=activity,
    ...
    def get_members_by_id_org(
        ...
        raw_response = self.raw.get_members_by_id_org(
            id_org=id_org,
            filter=filter,
            fields=fields,
            activity=activity,
