...
class BaseApi(api_client.Api):
    ...
    def _get_check_items_by_id_checklist_mapped_args(
        self,
        id_checklist: str,
    ...
    async def _aget_check_items_by_id_checklist_oapg(
        self,
    ...
    def _get_check_items_by_id_checklist_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetCheckItemsByIdChecklistRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_check_items_by_id_checklist(
        self,
        id_checklist: str,
        filter: typing.Optional[str] = None,
        fields: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._get_check_items_by_id_checklist_mapped_args(
            id_checklist=id_checklist,
            filter=filter,
            fields=fields,
        )
        return await self._aget_check_items_by_id_checklist_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def get_check_items_by_id_checklist(
        self,
        id_checklist: str,
        filter: typing.Optional[str] = None,
        fields: typing.Optional[str] = None,
        ...
        return self._get_check_items_by_id_checklist_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetCheckItemsByIdChecklist(BaseApi):
    ...
    async def aget_check_items_by_id_checklist(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_check_items_by_id_checklist(
            id_checklist=id_checklist,
            filter=filter,
            fields=fields,
            **kwargs,
    ...
    def get_check_items_by_id_checklist(
        ...
        raw_response = self.raw.get_check_items_by_id_checklist(
            id_checklist=id_checklist,
            filter=filter,
            fields=fields,
        )
