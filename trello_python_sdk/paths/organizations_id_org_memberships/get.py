...
class BaseApi(api_client.Api):
    ...
    def _list_memberships_by_id_org_mapped_args(
        self,
        id_org: str,
    ...
    async def _alist_memberships_by_id_org_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/organizations/{idOrg}/memberships',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _list_memberships_by_id_org_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class ListMembershipsByIdOrgRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_memberships_by_id_org(
        self,
        id_org: str,
        filter: typing.Optional[str] = None,
        member: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._list_memberships_by_id_org_mapped_args(
            id_org=id_org,
            filter=filter,
            member=member,
            member_fields=member_fields,
        )
        return await self._alist_memberships_by_id_org_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def list_memberships_by_id_org(
        self,
        id_org: str,
        filter: typing.Optional[str] = None,
        member: typing.Optional[str] = None,
        ...
        return self._list_memberships_by_id_org_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class ListMembershipsByIdOrg(BaseApi):
    ...
    async def alist_memberships_by_id_org(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.alist_memberships_by_id_org(
            id_org=id_org,
            filter=filter,
            member=member,
            member_fields=member_fields,
    ...
    def list_memberships_by_id_org(
        ...
        raw_response = self.raw.list_memberships_by_id_org(
            id_org=id_org,
            filter=filter,
            member=member,
            member_fields=member_fields,
