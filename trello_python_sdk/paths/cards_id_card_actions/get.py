...
class BaseApi(api_client.Api):
    ...
    def _list_card_actions_by_id_mapped_args(
        self,
        id_card: str,
    ...
    async def _alist_card_actions_by_id_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/cards/{idCard}/actions',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _list_card_actions_by_id_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class ListCardActionsByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_card_actions_by_id(
        self,
        id_card: str,
        entities: typing.Optional[str] = None,
        display: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._list_card_actions_by_id_mapped_args(
            id_card=id_card,
            entities=entities,
            display=display,
            filter=filter,
        ...
        return await self._alist_card_actions_by_id_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def list_card_actions_by_id(
        self,
        id_card: str,
        entities: typing.Optional[str] = None,
        display: typing.Optional[str] = None,
        ...
        return self._list_card_actions_by_id_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class ListCardActionsById(BaseApi):
    ...
    async def alist_card_actions_by_id(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.alist_card_actions_by_id(
            id_card=id_card,
            entities=entities,
            display=display,
            filter=filter,
    ...
    def list_card_actions_by_id(
        ...
        raw_response = self.raw.list_card_actions_by_id(
            id_card=id_card,
            entities=entities,
            display=display,
            filter=filter,
