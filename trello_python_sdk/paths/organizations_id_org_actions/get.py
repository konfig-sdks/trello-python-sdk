...
class BaseApi(api_client.Api):
    ...
    def _get_actions_by_id_org_mapped_args(
        self,
        id_org: str,
    ...
    async def _aget_actions_by_id_org_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/organizations/{idOrg}/actions',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_actions_by_id_org_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetActionsByIdOrgRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_actions_by_id_org(
        self,
        id_org: str,
        entities: typing.Optional[str] = None,
        display: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._get_actions_by_id_org_mapped_args(
            id_org=id_org,
            entities=entities,
            display=display,
            filter=filter,
        ...
        return await self._aget_actions_by_id_org_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def get_actions_by_id_org(
        self,
        id_org: str,
        entities: typing.Optional[str] = None,
        display: typing.Optional[str] = None,
        ...
        return self._get_actions_by_id_org_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetActionsByIdOrg(BaseApi):
    ...
    async def aget_actions_by_id_org(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_actions_by_id_org(
            id_org=id_org,
            entities=entities,
            display=display,
            filter=filter,
    ...
    def get_actions_by_id_org(
        ...
        raw_response = self.raw.get_actions_by_id_org(
            id_org=id_org,
            entities=entities,
            display=display,
            filter=filter,
