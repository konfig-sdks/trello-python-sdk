...
class BaseApi(api_client.Api):
    ...
    def _get_invited_boards_mapped_args(
        self,
        id_member: str,
    ...
    async def _aget_invited_boards_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/members/{idMember}/boardsInvited',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetInvitedBoardsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_invited_boards(
        self,
        id_member: str,
        fields: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._get_invited_boards_mapped_args(
            id_member=id_member,
            fields=fields,
        )
        return await self._aget_invited_boards_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def get_invited_boards(
        self,
        id_member: str,
        fields: typing.Optional[str] = None,
    ) -> typing.Union[
        ...
        return self._get_invited_boards_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetInvitedBoards(BaseApi):
    ...
    async def aget_invited_boards(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_invited_boards(
            id_member=id_member,
            fields=fields,
            **kwargs,
        )
    ...
    def get_invited_boards(
        ...
        raw_response = self.raw.get_invited_boards(
            id_member=id_member,
            fields=fields,
        )
