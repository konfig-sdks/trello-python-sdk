...
class BaseApi(api_client.Api):
    ...
    def _remove_checklist_check_item_mapped_args(
        self,
        id_card: str,
        id_checklist: str,
        id_check_item: str,
    ...
    async def _aremove_checklist_check_item_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/cards/{idCard}/checklist/{idChecklist}/checkItem/{idCheckItem}',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _remove_checklist_check_item_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class RemoveChecklistCheckItemRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aremove_checklist_check_item(
        self,
        id_card: str,
        id_checklist: str,
        id_check_item: str,
        **kwargs,
        ...
        args = self._remove_checklist_check_item_mapped_args(
            id_card=id_card,
            id_checklist=id_checklist,
            id_check_item=id_check_item,
        )
        return await self._aremove_checklist_check_item_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def remove_checklist_check_item(
        self,
        id_card: str,
        id_checklist: str,
        id_check_item: str,
        ...
        return self._remove_checklist_check_item_oapg(
            path_params=args.path,
        )

class RemoveChecklistCheckItem(BaseApi):
    ...
    async def aremove_checklist_check_item(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aremove_checklist_check_item(
            id_card=id_card,
            id_checklist=id_checklist,
            id_check_item=id_check_item,
            **kwargs,
    ...
    def remove_checklist_check_item(
        ...
        raw_response = self.raw.remove_checklist_check_item(
            id_card=id_card,
            id_checklist=id_checklist,
            id_check_item=id_check_item,
        )
