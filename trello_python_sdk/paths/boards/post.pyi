...
class CreateBoardRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_board(
        self,
        closed: typing.Optional[str] = None,
        desc: typing.Optional[str] = None,
        id_board_source: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._create_board_mapped_args(
            closed=closed,
            desc=desc,
        ...
        return await self._acreate_board_oapg(
            body=args.body,
            **kwargs,
        )
    ...
    def create_board(
        ...
        return self._create_board_oapg(
            body=args.body,
        )

class CreateBoard(BaseApi):
    ...
    async def acreate_board(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acreate_board(
            closed=closed,
            desc=desc,
            id_board_source=id_board_source,
            id_organization=id_organization,
    ...
    def create_board(
        ...
        raw_response = self.raw.create_board(
            closed=closed,
            desc=desc,
            id_board_source=id_board_source,
            id_organization=id_organization,
