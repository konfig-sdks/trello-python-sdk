...
class BaseApi(api_client.Api):
    ...
    def _get_board_by_id_checklist_mapped_args(
        self,
        id_checklist: str,
    ...
    async def _aget_board_by_id_checklist_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/checklists/{idChecklist}/board',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_board_by_id_checklist_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetBoardByIdChecklistRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_board_by_id_checklist(
        self,
        id_checklist: str,
        fields: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._get_board_by_id_checklist_mapped_args(
            id_checklist=id_checklist,
            fields=fields,
        )
        return await self._aget_board_by_id_checklist_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def get_board_by_id_checklist(
        self,
        id_checklist: str,
        fields: typing.Optional[str] = None,
    ) -> typing.Union[
        ...
        return self._get_board_by_id_checklist_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetBoardByIdChecklist(BaseApi):
    ...
    async def aget_board_by_id_checklist(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_board_by_id_checklist(
            id_checklist=id_checklist,
            fields=fields,
            **kwargs,
        )
    ...
    def get_board_by_id_checklist(
        ...
        raw_response = self.raw.get_board_by_id_checklist(
            id_checklist=id_checklist,
            fields=fields,
        )
