    ...
    async def _aget_boards_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/members/{idMember}/boards/{filter}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetBoardsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_boards(
        self,
        id_member: str,
        filter: str,
        **kwargs,
        ...
        args = self._get_boards_mapped_args(
            id_member=id_member,
            filter=filter,
        )
        return await self._aget_boards_oapg(
    ...
    def get_boards(
        ...
        return self._get_boards_oapg(
            path_params=args.path,
        )

class GetBoards(BaseApi):
    ...
    async def aget_boards(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_boards(
            id_member=id_member,
            filter=filter,
            **kwargs,
        )
    ...
    def get_boards(
        ...
        raw_response = self.raw.get_boards(
            id_member=id_member,
            filter=filter,
        )
