...
class Webhooks(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["description", "active", "callbackURL", "idModel", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["description", "active", "callbackURL", "idModel", ], str]):
