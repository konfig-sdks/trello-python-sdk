...
class Labels(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["color", "idBoard", "name", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["color", "idBoard", "name", ], str]):
