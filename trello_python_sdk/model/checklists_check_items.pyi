...
class ChecklistsCheckItems(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["checked", "name", "pos", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["checked", "name", "pos", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        checked: typing.Union[MetaOapg.properties.checked, str, schemas.Unset] = schemas.unset,
