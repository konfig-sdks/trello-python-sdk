...
class ListsCards(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["desc", "due", "idMembers", "labels", "name", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["desc", "due", "idMembers", "labels", "name", ], str]):
