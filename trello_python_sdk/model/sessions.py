...
class Sessions(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["idBoard", "status", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["idBoard", "status", ], str]):
