...
class MembersSavedSearches(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "pos", "query", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "pos", "query", ], str]):
