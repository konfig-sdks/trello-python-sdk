...
class CardsIdBoard(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["idList", "value", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["idList", "value", ], str]):
